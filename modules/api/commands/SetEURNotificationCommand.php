...
class SetEURNotificationCommand extends BaseCommand {
    ...
    public function execute()
    {
        if ($this->answer) {
            ($this->answer == \Yii::t('app', 'Remove all'))
                ? $this->removeAll($this->user->id, Notifications::TYPE_AUCTION_EUR)
                : $this->addNotify($this->answer, Notifications::TYPE_AUCTION_EUR);
        } else {
